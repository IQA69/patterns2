...
public class AuthPath {
    ...
    void shouldErrorIfUserNotRegistered() {
        ...
        $("button.button").click();
        $(".notification__content").shouldHave(Condition.exactText("Ошибка! Неверно указан логин или пароль"), Duration.ofSeconds(10))
    ...
    void shouldErrorIfUserBlocked() {
        ...
        $("button.button").click();
        $(".notification__content").shouldHave(Condition.exactText("Ошибка! Пользователь заблокирован"), Duration.ofSeconds(10))
                .shouldBe(Condition.visible);
    }
}